...
// let c1 = ["Poseiodon", "Athena", "Zeus", "Circe"];
...
// for (let i = 0; i < 5; i++)
// {
//     starter_questions.push(new question(prompts[i], choices[i], answers[i]));
// }

starter_questions = [new question("A", ["A", "B", "C"], "A"), new question("B", ["X", "Y", "Z", "0"], "0")];
